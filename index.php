...
<head>
    ...
    .menu-item:hover {
        ...
        box-shadow: 0 8px 25px rgba(224,192,128,0.2);
    ...
    .add-to-cart-btn {
        ...
        border: none;
        border-radius: 8px;
        background: linear-gradient(135deg, #e0c080, #d4af37);
        color: #1a1a1a;
        font-weight: 600;
        cursor: pointer;
        transition: all 0.3s ease;
                    ...
                    <div class="menu-item">
                        ...
                        <div class="menu-item-content">
                            ...
                            <div class="menu-item-footer">
                                ...
                                <button class="add-to-cart-btn" onclick="addToCart(<?php echo $item['id']; ?>, event)">
                                    Add to Cart
                                </button>
                            </div>
                        </div>
